    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success"> is complete</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirements to extract reality seeds and auto-generate suitable ontology structure
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success"> is complete</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on generated ontology, automatically chunk document and call Zep to build knowledge graph, extracting entities/relations, and form sequential memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">          Graph Building Complete, please proceed to next step for simulation environment setup</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? '创建中...' : 'Enter Environment Setup ➝' }}
          </button>
        </div>
      </div>
    </div>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert('创建模拟Failed: ' + (res.error || '未知错误'))
    }
  } catch (err) {
