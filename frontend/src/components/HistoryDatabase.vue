  ...
  >
    ...
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <!-- 卡片标题（使用Simulation Req.的前20字作为标题） -->
        <h3 class="card-title">{{ getSimulationTitle(project.simulation_requirement) }}</h3>

        <!-- 卡片描述（Simulation Req.完整展示） -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                <div class="modal-label">Simulation Req.</div>
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>暂无Related Files</div>
              </div>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 (Start Simulation) and Step 5 (Deep Interaction) require execution and do not support historical playback</span>
            </div>
          </div>
        </div>
      </Transition>
...
.modal-btn.btn-interaction:not(:disabled):hover {
  border-color: #8B5CF6;
  background: #F5F3FF;
