      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            ...
            <p class="slogan-text">
              Rehearse the future among Agents, let the decision win after hundred battles<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload multiple unstructured data to initialize simulation sequences.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform simulation & Auto-parse predictions & Dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent has a rich toolset to interact with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe simulation or prediction requirements in natural language (e.g., What public opinion trend will emerge if Wuhan University announces the revocation of an expulsion?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
            ...
            <div class="api-key-section">
              <div class="api-key-header">
                ...
                <span class="api-key-label">Model Provider</span>
                <span class="api-key-hint">Select the LLM model to use</span>
              </div>
              <div class="api-key-input-wrapper" style="margin-bottom: 16px;">
                <select v-model="selectedModel" class="api-key-input model-select">
              ...
              <div class="api-key-header">
                ...
                <span class="api-key-hint">Required for {{ currentModel.name }}</span>
              </div>
              ...
              <div class="api-key-footer">
                <span class="api-key-status" :class="{ active: apiKey.trim() }">
                  <span class="status-indicator"></span>
                  {{ apiKey.trim() ? 'Key provided' : 'No key entered' }}
                </span>
              </div>
            </div>
          </div>
...
const availableModels = [
  { id: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash', modelName: 'gemini-1.5-flash', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai/' },
  { id: 'gemini-1.5-pro', name: 'Gemini 1.5 Pro', modelName: 'gemini-1.5-pro', baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai/' },
  { id: 'openai-gpt-4o', name: 'OpenAI GPT-4o', modelName: 'gpt-4o', baseUrl: 'https://api.openai.com/v1' },
  { id: 'openrouter-qwen', name: 'OpenRouter (Qwen Free)', modelName: 'qwen/qwen3-coder:free', baseUrl: 'https://openrouter.ai/api/v1' }
]
const selectedModel = ref('gemini-1.5-flash')

const currentModel = computed(() => {
  return availableModels.find(m => m.id === selectedModel.value) || availableModels[0]
})
...
.api-key-status.active .status-indicator {
  background: #4CAF50;
