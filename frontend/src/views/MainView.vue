      ...
      <div class="header-center">
        <div class="view-switcher">
          <button 
            ...
            @click="viewMode = mode"
          >
            {{ { graph: 'Graph', split: 'Dual Column', workbench: 'Workbench' }[mode] }}
          </button>
        </div>
      </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending && !pending.simulationRequirement) {
    error.value = 'No pending simulation requirement found.'
    addLog('Error: No pending simulation requirement for new project.')
    return
  }
